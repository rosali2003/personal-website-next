      ...
      <div className="grid grid-cols-1 sm:grid-cols-12">
        ...
        >
          ...
          <div className="flex flex-row items-center gap-2 py-6">
            ...
            <Link href="../../../public/RosaLiResume09:06:2023.pdf">
            <Image src={DocumentIcon} alt="Github Icon" />
            </Link>
            
          </div>
          <p className="text-[#ADB7BE] text-base sm:text-lg mb-6 lg:text-xl">
            {"Hello! I'm Rosa, a 3rd year Computer Science student at"}{" "}
            <br></br>
            {"Carleton University, Ottawa. I'm currently a Dev Degree"}{" "}
            <br></br>{" "}
            {"intern at Shopify, a frontend intern on the Shop Pay team"}
          </p>
